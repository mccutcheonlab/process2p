...
def run_processing(config_file, get_metafile, animals, dates, use_fast_dir, overwrite, get_behav, get_data, prep_for_s2p, imagej_z, do_suite2p, delete_intermediates, verbose, keep_on_fast_dir):
